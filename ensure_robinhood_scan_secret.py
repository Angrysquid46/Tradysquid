"""Create a strong ignored local Robinhood-scan webhook secret when missing."""
...
ENV_PATH = ROOT / ".env"
KEY = "ROBINHOOD_SCAN_WEBHOOK_SECRET"
...
def main() -> int:
    ...
    print(
        "Robinhood-scan webhook secret created locally."
        if created
        else "Robinhood-scan webhook secret already exists."
    )
