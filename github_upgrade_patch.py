...
def _upgrade_destination() -> tuple[Any | None, str]:
    tracker = bot.discord_transport.DiscordTracker(
        bot.discord_transport.DISCORD_BOT_TOKEN,
        bot.discord_transport.DISCORD_GUILD_ID,
    )
...
def install() -> None:
    ...
    def process_command(interaction: dict[str, Any]) -> None:
        ...
        except (bot.requests.RequestException, bot.discord_transport.DiscordError):
            pass
