...
def test_regular_accepts_a_delta_inside_its_narrower_range():
    ...
    candidates = ford_scan.scan_single_legs(chain, "call", "2026-08-14", "REGULAR")
...
def test_the_old_shared_constants_still_exist_for_backward_compatibility():
    assert ford_scan.SINGLE_LEG_DELTA_MIN == 0.20
    assert ford_scan.SINGLE_LEG_DELTA_MAX == 0.80
